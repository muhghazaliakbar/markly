...
> Quotes get a soft accent bar on the left,
> and nested ones stack.

Inline math like $e^{i\pi} + 1 = 0$ and code blocks:

```swift
let greeting = "Hello, Markly"
print(greeting)
```
